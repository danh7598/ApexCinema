...
const Onboarding3 = ({ navigation }) => {
  const onPressStarted = () => {
    navigation.navigate("SignInAndUpScreen");
  };
  return (
    <View collapsable={false} style={styles.container}>
      <Image style={styles.imgIllus} source={IllusOnboarding3} />
      ...
      <TextTitle
        ...
        textLight={
          "Nudooz Cinema app is great in design and incredibly simple to use"
        }
      />
      <Button
